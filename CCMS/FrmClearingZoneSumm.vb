...
Public Class FrmClearingZoneSumm
...
#Region "user defined codes"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_GetDetailList")
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmZoneDet As New FrmClearingZoneDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmZoneDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmZoneDet As New FrmClearingZoneDet()
        frmZoneDet.Show()
