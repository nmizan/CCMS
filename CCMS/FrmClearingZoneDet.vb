...
Public Class FrmClearingZoneDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceClearingZoneDetail"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_Add")
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_Update")
    ...
    Private Sub LoadZoneData(ByVal strZoneCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_GetDetail")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_GetMaxMod")
    ...
    Private Function AuthorizeData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_Auth")
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingZone_Remove")
...
#End Region
    ...
    Private Sub txtId_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtId.KeyDown
        If e.KeyCode = Keys.Enter And txtId.Text.Trim() <> "" Then
            SendKeys.Send("{tab}")
        End If
    End Sub
    ...
    Private Sub txtName_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyDown
        If e.KeyCode = Keys.Enter And txtName.Text.Trim() <> "" Then
