...
Public Class FrmCheckTypeSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceChequeTypeSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CheckType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("CHECKTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("CHECKTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmCheckTypeDet As New FrmCheckTypeDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmCheckTypeDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmCheckTypeDet As New FrmCheckTypeDet()
        frmCheckTypeDet.Show()
    ...
    Private Sub FrmZoneSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        '------------Mizan Work (18-05-2016)------------
                        LoadCheckTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)

                        If (dgView.Rows(i).Cells(1).Value) > 1 Then
                            LoadCheckTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                        End If
                        '------------Mizan Work (18-05-2016)------------

                        commProc.Parameters.Clear()

                        db.AddInParameter(commProc, "@CHECKTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                        ...
                        If result = 0 Then
                            ...
                            If _aCTName <> _CTName Then
                                If _aCTName = "" Then
                                    log_message = " Authorized : Check Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Check Type Name : " + _CTName
                                Else
                                    log_message = " Authorized : Check Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Check Type Name : " + _aCTName + " " + " To " + " " + _CTName
                                End If
                            Else
                                log_message = " Authorized : Check Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Check Type Name : " + dgView.Rows(i).Cells(4).Value.ToString()
                            End If
