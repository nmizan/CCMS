...
Public Class FrmZoneDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceZoneDetail"
    Dim opt As SecForm = New SecForm(_formName)


    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strZone_Code As String = ""
    Dim _mod_datetime As Date
    Dim _status As String = ""
    Dim log_message As String

    'For Update
    Dim _ZoneName As String = ""

    'For Auth
    Dim _aZoneName As String = ""
#End Region
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Zone_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ZONE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@ZONE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strZone_Code = txtId.Text.Trim()

                _intModno = 1

                '------------Mizan Work (07-05-2016)------------

                log_message = " Added : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Zone_Update")
            ...
            If result = 0 Then
                ...
                '------------Mizan Work (07-05-2016)------------
                If _ZoneName <> txtName.Text.Trim() Then
                    If _ZoneName = "" Then
                        log_message = " Updated : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + txtName.Text.ToString()
                    Else
                        log_message = " Updated : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + _ZoneName + " " + " To " + " " + txtName.Text.Trim()
                    End If
                Else
                    log_message = " Updated : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + txtName.Text.ToString()
                End If
    ...
    Private Sub LoadZoneDataForAuth(ByVal strZoneCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From ZONE Where ZONE_CODE ='" & strZoneCode & "' and STATUS='L'")

            If ds.Tables(0).Rows.Count > 0 Then


                _strZone_Code = strZoneCode
                
                txtId.Text = ds.Tables(0).Rows(0)("ZONE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ZONE_NAME").ToString()
                _aZoneName = ds.Tables(0).Rows(0)("ZONE_NAME").ToString()
        ...
        End Try
    End Sub
    Private Sub LoadZoneData(ByVal strZoneCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Zone_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ZONE_CODE", DbType.String, strZoneCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ZONE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ZONE_NAME").ToString()
                _ZoneName = ds.Tables(0).Rows(0)("ZONE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_Zone_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@ZONE_CODE", DbType.String, strZoneCode)
    ...
    Public Sub New(ByVal strZoneCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadZoneData(strZoneCode, intMod)
        _strZone_Code = strZoneCode
        _intModno = intMod
    ...
    Private Function AuthorizeData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Zone_Auth")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@ZONE_CODE", DbType.String, _strZone_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        ...
        If result = 0 Then
            ...
            '------------Mizan Work (11-05-2016)------------
            If _aZoneName <> _ZoneName Then
                If _aZoneName = "" Then
                    log_message = " Authorized : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + _ZoneName
                Else
                    log_message = " Authorized : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + _aZoneName + " " + " To " + " " + _ZoneName
                End If
            Else
                log_message = " Authorized : Zone Code : " + txtId.Text.Trim() + "." + " " + " Zone Name : " + txtName.Text.ToString()
            End If
            Logger.system_log(log_message)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Zone_Remove")
...
#End Region
    ...
    Private Sub FrmZoneDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadZoneData(_strZone_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strZone_Code.Trim() = "") Then
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        ...
        Try
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If _intModno > 1 Then
                    LoadZoneDataForAuth(_strZone_Code)
                End If
