...
Public Class FrmCitiSpeedSumm

#Region "user defined codes"

    Dim _formName As String = "DepositCitiSpeedSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CSD_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(4, i).Value = dt.Rows(i).Item("INPUT_BY").ToString()
                dgView.Item(5, i).Value = NullHelper.DateToString(dt.Rows(i).Item("INPUT_DATETIME"))
                dgView.Item(6, i).Value = dt.Rows(i).Item("INPUT_DATETIME")
                dgView.Item(7, i).Value = dt.Rows(i).Item("AUTH_BY").ToString()
                dgView.Item(8, i).Value = NullHelper.DateToString(dt.Rows(i).Item("AUTH_DATETIME"))
            Next
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmSpeedDet As New FrmCitiSpeedDetail(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmSpeedDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmSpeedDet As New FrmCitiSpeedDetail
        frmSpeedDet.Show()
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        If (dgView.Rows(i).Cells(1).Value > 1) Then
                            ...
                            db.AddInParameter(cmd, "@D_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                            db.ExecuteNonQuery(cmd)
                        End If
                        db.AddInParameter(commProc, "@MOD_DATETIME", DbType.DateTime, dgView.Rows(i).Cells(6).Value)
                        ...
                        If result = 0 Then
                            ...
                            log_message = " Authorized : Citi Speed Deposit Code : " + dgView.Rows(i).Cells(3).Value.ToString()
