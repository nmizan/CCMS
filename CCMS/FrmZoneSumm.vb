...
Public Class FrmZoneSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceZoneSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Zone_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("ZONE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("ZONE_NAME").ToString()
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmZoneDet As New FrmZoneDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmZoneDet.ShowDialog()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmZoneDet As New FrmZoneDet()
        frmZoneDet.ShowDialog()
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        '------------Mizan Work (18-05-2016)------------
                        LoadZoneData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)

                        If (dgView.Rows(i).Cells(1).Value) > 1 Then
                            LoadZoneDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                        End If
                        '------------Mizan Work (18-05-2016)------------
                        ...
                        db.AddInParameter(commProc, "@ZONE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                        ...
                        If result = 0 Then
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                If _aZoneName <> _ZoneName Then
                                    If _aZoneName = "" Then
                                        log_message = " Authorized : Zone Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Zone Name : " + _ZoneName
                                    Else
                                        log_message = " Authorized : Zone Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Zone Name : " + _aZoneName + " " + " To " + " " + _ZoneName
                                    End If
                                Else
                                    log_message = " Authorized : Zone Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Zone Name : " + dgView.Rows(i).Cells(4).Value.ToString()
                                End If
