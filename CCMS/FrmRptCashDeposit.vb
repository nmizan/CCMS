...
Public Class FrmRptCashDeposit

    Dim _formName As String = "ReportReportsCitiCashDeposit"
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If txtScheduleDateFrom.Text.Trim() <> "/  /" And txtScheduleDateTo.Text.Trim() <> "/  /" Then
            ...
            strFormula = "{V_CASH_DEPOSIT.SCHEDULE_DATE}>=#" & NullHelper.StringToCrDateString(txtScheduleDateFrom.Text.Trim()) & _
               "# AND {V_CASH_DEPOSIT.SCHEDULE_DATE}<=#" & NullHelper.StringToCrDateString(txtScheduleDateTo.Text.Trim()) & "#"
        ...
        If txtLocationCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_CASH_DEPOSIT.LOCATION_CODE}='" & txtLocationCode.Text.Trim() & "'"
            strAndOr = " AND "
        ...
        If txtClientCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_CASH_DEPOSIT.CLIENT_CODE}='" & txtClientCode.Text.Trim() & "'"
            strAndOr = " AND "
    ...
    Private Sub FrmRptCashDeposit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnReportExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReportExcel.Click
        ...
        Try
            ...
            strSql = "SELECT ACC_NAME AS CLIENT,'''' + CLIENT_CODE AS 'CLIENT CODE',ACC_NO, " & _
                "LOCATION_NAME,SCHEDULE_DATE,'''' + D_CODE AS 'DEPOSIT SLIP NO.', " & _
                "'''' + REF_NO AS 'DEPOSIT REFERENCE',CUSTOMER_REF,CITICASH_AMOUNT  " & _
                "FROM V_CASH_DEPOSIT "
