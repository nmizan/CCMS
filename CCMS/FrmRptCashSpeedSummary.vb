...
Public Class FrmRptCashSpeedSummary

    Dim _formName As String = "ReportReportsCitiCashSpeedSummary"
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Dim rd As New crCashSpeedDetail()
        ...
        If txtScheduleDateFrom.Text.Trim() <> "/  /" And txtScheduleDateTo.Text.Trim() <> "/  /" Then
            ...
            strFormula = "{V_SPEEDCASH_DETAIL.SCHEDULE_DATE}>=#" & NullHelper.StringToCrDateString(txtScheduleDateFrom.Text.Trim()) & _
               "# AND {V_SPEEDCASH_DETAIL.SCHEDULE_DATE}<=#" & NullHelper.StringToCrDateString(txtScheduleDateTo.Text.Trim()) & "#"
        ...
        If txtEntryDateFrom.Text.Trim() <> "/  /" And txtEntryDateTo.Text.Trim() <> "/  /" Then
            ...
            strFormula = strFormula + strAndOr + "{V_SPEEDCASH_DETAIL.ENTRY_DATE}>=#" & NullHelper.StringToCrDateString(txtEntryDateFrom.Text.Trim()) & _
               "# AND {V_SPEEDCASH_DETAIL.ENTRY_DATE}<=#" & NullHelper.StringToCrDateString(txtEntryDateTo.Text.Trim()) & "#"
        ...
        If txtBankCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_SPEEDCASH_DETAIL.CORR_BANK_CODE}='" & txtBankCode.Text.Trim() & "'"
            strAndOr = " AND "
        ...
        If txtLocationCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_SPEEDCASH_DETAIL.LOCATION_CODE}='" & txtLocationCode.Text.Trim() & "'"
            strAndOr = " AND "
        ...
        If txtClientCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_SPEEDCASH_DETAIL.CLIENT_CODE}='" & txtClientCode.Text.Trim() & "'"
            strAndOr = " AND "
    ...
    Private Sub FrmRptCashSpeedSummary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnReportExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReportExcel.Click
        ...
        Try
            ...
            strSql = "SELECT ACC_NAME AS 'CLIENT','''' + CLIENT_CODE AS 'CLIENT CODE',ACC_NO, " & _
                ...
                "BANK_NAME,CITICASH_AMOUNT,CITICHECK_AMOUNT " & _
                " FROM V_SPEEDCASH_DETAIL "
