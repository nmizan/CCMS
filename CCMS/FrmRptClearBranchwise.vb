...
Public Class FrmRptClearBranchwise

    Dim _formName As String = "ReportReportsBankwiseDeliveryCheck"
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Dim rd As New crBankWiseDeliveryCheck()
        ...
        If txtDepositDateFrom.Text.Trim() <> "/  /" And txtDepositDateTo.Text.Trim() <> "/  /" Then
            ...
            strFormula = "{V_CLEAR_CHECK_BANK.OPR_DATE}>=#" & NullHelper.StringToCrDateString(txtDepositDateFrom.Text.Trim()) & _
                "# AND {V_CLEAR_CHECK_BANK.OPR_DATE}<=#" & NullHelper.StringToCrDateString(txtDepositDateTo.Text.Trim()) & "#"
        ...
        If cmbEntryLocation.SelectedIndex > -1 Then
            ...
            strFormula = strFormula + strAndOr + "{V_CLEAR_CHECK_BANK.ENTRY_LOC}='" & cmbEntryLocation.SelectedValue & "'"
            strAndOr = " AND "
        ...
        If cmbValueType.SelectedIndex > -1 Then
            ...
            strFormula = strFormula + strAndOr + "{V_CLEAR_CHECK_BANK.VALUE_TYPE}=" & cmbValueType.SelectedValue & ""
            strAndOr = " AND "
        ...
        If txtBankCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_CLEAR_CHECK_BANK.BANK_CODE}='" & txtBankCode.Text.Trim() & "'"
            strAndOr = " AND "
