...
Public Class FrmProcessSameDayMis

#Region "Global Variables"

    Dim _formName As String = "DepositSameDayMISProcess"
...
#End Region
    ...
    Private Sub FrmProcessSameDayMis_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Function ProcessData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Process_SameDayMis")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@TRANSDATE", DbType.DateTime, NullHelper.StringToDate(txtTransDate.Text.Trim()))
        ...
        If result = 0 Then
            ...
            log_message = " Same Day MIS Process : " + " " + txtTransDate.Text.Trim() + " " + " Completed Successfully !! "
