...
Public Class FrmRptUsersInactivity
    ...
    Private Sub CreateReportDocument()
        ...
        _document.Info.Title = "Users Inactivity Report"
        _document.Info.Subject = "Report showing users inactivity."
    ...
    Private Sub CreatePage()
        ...
        paragraph.AddText("Users Inactivity Report")
    ...
    Private Sub CreateTable()
        ...
        row.Cells(2).AddParagraph("Days of inactivity")
    ...
    Private Sub FillContent()
        ...
        strSql = "SELECT * FROM V_USER_INACTIVITY " & _
        ...
        For i = 0 To dt.Rows.Count - 1
            ...
            paragraph.AddText(NullHelper.ObjectToString(dt.Rows(i)("USERS_NAME")))
            row1.Cells(1).Format.Alignment = ParagraphAlignment.Left

            row1.Cells(2).AddParagraph(NullHelper.ObjectToString(dt.Rows(i)("DayDiff")))
            row1.Cells(2).Format.Alignment = ParagraphAlignment.Right

            row1.Cells(3).AddParagraph(IIf(dt.Rows(i)("USER_STAT") = "E", "Enable", "Disable"))
