...
#Region "Global Variables"
    ...
    Dim _formName As String = "SystemFunctionalGroupDetail"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_FGroup_Add")
                ...
                Else
                    ...
                    Dim commProcForm As DbCommand = db.GetStoredProcCommand("CMS_PermForms_Add")
                    ...
                    '--------- for Menu Permission ---------------------
                    Dim commProcMenu As DbCommand = db.GetStoredProcCommand("CMS_PermMenus_Add")
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_FGroup_Update")
                ...
                ElseIf result = 0 Then
                    ...
                    Dim commProcForm As DbCommand = db.GetStoredProcCommand("CMS_PermForms_Update")
                    ...
                    Dim commProcMenu As DbCommand = db.GetStoredProcCommand("CMS_PermMenus_Update")
                    ...
                    If _funcName <> txtName.Text.Trim() Then
    ...
    Private Function AuthorizeData() As TransState
        ...
        If result = 0 Then
            ...
            If _afuncName <> _funcName Then
                ...
                Else
                    log_message = " Authorized : Functional Group :  " + txtId.Text.Trim() + "." + " " + " Name : " + _afuncName + " " + " To " + " " + _funcName
                End If
                Logger.system_log(log_message)
            Else
    ...
    Private Sub LoadGroupData(ByVal intSlno As Integer, ByVal intmod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_FGroup_GetMaxMod")
    ...
    Private Sub LoadFormMenuData(ByVal intSlno As Integer, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcForm As DbCommand = db.GetStoredProcCommand("CMS_PermForms_GetDetails")
            ...
            Dim commProcMenu As DbCommand = db.GetStoredProcCommand("CMS_PermMenus_GetDetails")
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_FGroup_Remove")
        ...
        If result = 0 Then
            ...
            Logger.system_log("Functional Group:" + txtId.Text.ToString() + " Deleted")
            ...
            If MessageBox.Show("Do you really want to Save?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If CheckValidData() Then
                    ...
                    If tState = TransState.Add Then
                        ...
                        'Logger.system_log("Functional Group:" + txtId.Text.ToString() + " Added")
                    ...
                    ElseIf tState = TransState.Update Then
                        ...
                        'Logger.system_log("Functional Group:" + txtId.Text.ToString() + " Updated")
        ...
        Try
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If tState = TransState.Update Then
                    ...
                    Logger.system_log("Functional Group:" + txtId.Text.ToString() + " Authorized")
