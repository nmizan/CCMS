...
Public Class FrmCitiCheckSumm

#Region "user defined codes"

    Dim _formName As String = "DepositCitiAnywhereSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CCheckTotal_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(4, i).Value = dt.Rows(i).Item("TOTAL_CHKNO").ToString()
                dgView.Item(5, i).Value = dt.Rows(i).Item("TOTAL_CHKAMT").ToString()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmCheckDet As New FrmCitiCheckDetail(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmCheckDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub LoadMainDataForAuth(ByVal strDCode As String)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                _acheckNo = NullHelper.ToIntNum(ds.Tables(0).Rows(0)("TOTAL_CHKNO")).ToString

                _atotalAmt = NullHelper.ToDecNum(ds.Tables(0).Rows(0)("TOTAL_CHKAMT")).ToString
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        If result = 0 Then
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                _log = " Authorized : Citi Anywhere Check Deposit Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + _AnyLog
                            ...
                            Else
                                ...
                                _log = " Authorized : Deposit Code : " + dgView.Rows(i).Cells(3).Value.ToString()
