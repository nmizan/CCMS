...
Public Class FrmRptClearCheckSumm

    Dim _formName As String = "ReportReportsClearingCheckSummary"
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Dim rd As New crAccWiseClearCheckSumm()
        ...
        If txtDepositDateFrom.Text.Trim() <> "/  /" And txtDepositDateTo.Text.Trim() <> "/  /" Then
            ...
            strFormula = "{V_CLEAR_CHECK.OPR_DATE}>=#" & NullHelper.StringToCrDateString(txtDepositDateFrom.Text.Trim()) & _
                "# AND {V_CLEAR_CHECK.OPR_DATE}<=#" & NullHelper.StringToCrDateString(txtDepositDateTo.Text.Trim()) & "#"
        ...
        If cmbEntryLocation.SelectedIndex > -1 Then
            ...
            strFormula = strFormula + strAndOr + "{V_CLEAR_CHECK.ENTRY_LOC}='" & cmbEntryLocation.SelectedValue & "'"
            strAndOr = " AND "
        ...
        If cmbValueType.SelectedIndex > -1 Then
            ...
            strFormula = strFormula + strAndOr + "{V_CLEAR_CHECK.VALUE_TYPE}=" & cmbValueType.SelectedValue & ""
            strAndOr = " AND "
        ...
        If txtClientCode.Text.Trim() <> "" Then
            ...
            strFormula = strFormula + strAndOr + "{V_CLEAR_CHECK.REMARK}='" & txtClientCode.Text.Trim() & "'"
            strAndOr = " AND "
