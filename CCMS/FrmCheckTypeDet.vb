...
'Purpose            : Maintain Check Type Information
...
Public Class FrmCheckTypeDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceChequeTypeDetail"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strCheckType_Code As String = ""
    Dim _mod_datetime As Date
    Dim _status As String = ""
    Dim log_message As String

    'For Update
    Dim _CTName As String = ""

    'For Auth
    Dim _aCTName As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CheckType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@CHECKTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@CHECKTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strCheckType_Code = txtId.Text.Trim()

                _intModno = 1

                '------------Mizan Work (07-05-2016)------------

                log_message = " Added : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CheckType_Update")
            ...
            If result = 0 Then
                ...
                '------------Mizan Work (07-05-2016)------------
                If _CTName <> txtName.Text.Trim() Then
                    If _CTName = "" Then
                        log_message = " Updated : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + txtName.Text.ToString()
                    Else
                        log_message = " Updated : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + _CTName + " " + " To " + " " + txtName.Text.Trim()
                    End If
                Else
                    log_message = " Updated : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + txtName.Text.ToString()
                End If
    ...
    Private Sub LoadCheckTypeDataForAuth(ByVal strCheckTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From CHECKTYPE Where CHECKTYPE_CODE ='" & strCheckTypeCode & "' and STATUS='L'")

            If ds.Tables(0).Rows.Count > 0 Then


                _strCheckType_Code = strCheckTypeCode
                

                txtId.Text = ds.Tables(0).Rows(0)("CHECKTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("CHECKTYPE_NAME").ToString()
                _aCTName = ds.Tables(0).Rows(0)("CHECKTYPE_NAME").ToString()
        ...
        End Try
    End Sub
    Private Sub LoadCheckTypeData(ByVal strCheckTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CheckType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@CHECKTYPE_CODE", DbType.String, strCheckTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("CHECKTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("CHECKTYPE_NAME").ToString()
                _CTName = ds.Tables(0).Rows(0)("CHECKTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_CheckType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@CHECKTYPE_CODE", DbType.String, strCheckTypeCode)
    ...
    Public Sub New(ByVal strCheckTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadCheckTypeData(strCheckTypeCode, intMod)
        _strCheckType_Code = strCheckTypeCode
        _intModno = intMod
    ...
    Private Function AuthorizeData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CheckType_Auth")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@CHECKTYPE_CODE", DbType.String, _strCheckType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        ...
        If result = 0 Then
            ...
            If _aCTName <> _CTName Then
                If _aCTName = "" Then
                    log_message = " Authorized : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + _CTName
                Else
                    log_message = " Authorized : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + _aCTName + " " + " To " + " " + _CTName
                End If
            Else
                log_message = " Authorized : Check Type Code : " + txtId.Text.Trim() + "." + " " + " Check Type Name : " + txtName.Text.ToString()
            End If
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_CheckType_Remove")
...
#End Region
    ...
    Private Sub FrmCheckTypeDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadCheckTypeData(_strCheckType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strCheckType_Code.Trim() = "") Then
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        ...
        Try
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If _intModno > 1 Then
                    LoadCheckTypeDataForAuth(_strCheckType_Code)
                End If
