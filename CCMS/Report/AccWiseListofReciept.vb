...
Public Class AccWiseListofReciept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AccWiseListofReciept.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.AccWiseListofReciept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAccWiseListofReciept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccWiseListofReciept = New AccWiseListofReciept
        rpt.Site = Me.Site
        Return rpt
    End Function
