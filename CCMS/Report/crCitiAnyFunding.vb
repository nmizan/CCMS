...
Public Class crCitiAnyFunding
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiAnyFunding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiAnyFunding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiAnyFunding = New crCitiAnyFunding
        rpt.Site = Me.Site
        Return rpt
    End Function
