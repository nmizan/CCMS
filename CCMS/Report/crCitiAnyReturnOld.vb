...
Public Class crCitiAnyReturnOld
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiAnyReturnOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiAnyReturnOld
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiAnyReturnOld = New crCitiAnyReturnOld
        rpt.Site = Me.Site
        Return rpt
    End Function
