...
Public Class crClearReturnSeq
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crClearReturnSeq.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrClearReturnSeq
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crClearReturnSeq = New crClearReturnSeq
        rpt.Site = Me.Site
        Return rpt
    End Function
