...
Public Class crDepositBreak
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crDepositBreak.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDepositBreak
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDepositBreak = New crDepositBreak
        rpt.Site = Me.Site
        Return rpt
    End Function
