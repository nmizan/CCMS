...
Public Class crBookingCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crBookingCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBookingCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBookingCheck = New crBookingCheck
        rpt.Site = Me.Site
        Return rpt
    End Function
