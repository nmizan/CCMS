...
Public Class CitiClearReturnRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.CitiClearReturnRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCitiClearReturnRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CitiClearReturnRpt = New CitiClearReturnRpt
        rpt.Site = Me.Site
        Return rpt
    End Function
