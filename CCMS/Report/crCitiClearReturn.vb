...
Public Class crCitiClearReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiClearReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiClearReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiClearReturn = New crCitiClearReturn
        rpt.Site = Me.Site
        Return rpt
    End Function
