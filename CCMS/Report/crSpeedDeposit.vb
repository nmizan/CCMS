...
Public Class crSpeedDeposit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crSpeedDeposit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSpeedDeposit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSpeedDeposit = New crSpeedDeposit
        rpt.Site = Me.Site
        Return rpt
    End Function
