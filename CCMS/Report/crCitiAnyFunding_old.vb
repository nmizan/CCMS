...
Public Class crCitiAnyFunding_old
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCitiAnyFunding_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiAnyFunding_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiAnyFunding_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiAnyFunding_old = New crCitiAnyFunding_old
        rpt.Site = Me.Site
        Return rpt
    End Function
