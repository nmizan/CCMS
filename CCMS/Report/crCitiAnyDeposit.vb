...
Public Class crCitiAnyDeposit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiAnyDeposit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiAnyDeposit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiAnyDeposit = New crCitiAnyDeposit
        rpt.Site = Me.Site
        Return rpt
    End Function
