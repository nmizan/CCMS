...
Public Class crDepositBreak2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crDepositBreak2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDepositBreak2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDepositBreak2 = New crDepositBreak2
        rpt.Site = Me.Site
        Return rpt
    End Function
