...
Public Class crSysLogReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crSysLogReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TEXT() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrSysLogReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSysLogReport = New crSysLogReport
        rpt.Site = Me.Site
        Return rpt
    End Function
