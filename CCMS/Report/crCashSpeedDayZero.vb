...
Public Class crCashSpeedDayZero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCashSpeedDayZero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCashSpeedDayZero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCashSpeedDayZero = New crCashSpeedDayZero
        rpt.Site = Me.Site
        Return rpt
    End Function
