...
Public Class crHighValueCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crHighValueCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrHighValueCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crHighValueCheck = New crHighValueCheck
        rpt.Site = Me.Site
        Return rpt
    End Function
