...
Public Class HighValueCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.HighValueCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHighValueCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HighValueCheck = New HighValueCheck
        rpt.Site = Me.Site
        Return rpt
    End Function
