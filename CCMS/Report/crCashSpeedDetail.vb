...
Public Class crCashSpeedDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCashSpeedDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCashSpeedDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCashSpeedDetail = New crCashSpeedDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
