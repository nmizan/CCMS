...
Public Class BankWiseDelivery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.BankWiseDelivery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBankWiseDelivery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BankWiseDelivery = New BankWiseDelivery
        rpt.Site = Me.Site
        Return rpt
    End Function
