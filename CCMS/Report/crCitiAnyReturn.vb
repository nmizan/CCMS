...
Public Class crCitiAnyReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiAnyReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiAnyReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiAnyReturn = New crCitiAnyReturn
        rpt.Site = Me.Site
        Return rpt
    End Function
