...
Public Class crCitiAnyReminder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCMS.crCitiAnyReminder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCitiAnyReminder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCitiAnyReminder = New crCitiAnyReminder
        rpt.Site = Me.Site
        Return rpt
    End Function
