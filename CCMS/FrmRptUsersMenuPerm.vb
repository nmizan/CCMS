...
Public Class FrmRptUsersMenuPerm
    ...
    Private Sub CreateReportDocument()
        ...
        _document.Info.Title = "Users Menu Permission Report"
    ...
    Private Sub CreateTable()
        ...
        row.Cells(2).AddParagraph("Menu Name")
        row.Cells(2).Format.Alignment = ParagraphAlignment.Left

        row.Cells(3).AddParagraph("Visible")
        row.Cells(3).Format.Alignment = ParagraphAlignment.Left

        row.Cells(4).AddParagraph("Enable")
    ...
    Private Sub FillContent()
        ...
        strSql = "SELECT * FROM V_USERS_ROLE_MENU_PERMISSION " & _
                    "  "
        ...
        For i = 0 To dt.Rows.Count - 1
            ...
            row1.Cells(2).AddParagraph(NullHelper.ObjectToString(dt.Rows(i)("MENU_NAME")))
            row1.Cells(2).Format.Alignment = ParagraphAlignment.Left

            row1.Cells(3).AddParagraph(NullHelper.ObjectToString(dt.Rows(i)("IS_VISIBLE")))
            row1.Cells(3).Format.Alignment = ParagraphAlignment.Left

            row1.Cells(4).AddParagraph(NullHelper.ObjectToString(dt.Rows(i)("IS_ENABLE")))
