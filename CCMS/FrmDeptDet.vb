...
'Purpose            : Maintain Department Detail
'Creation date      : 11-Nov-12
'Stored Procedure(s):  
'
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Department_Add")
            ...
            If result = 0 Then
                ...
                'Logger.system_log("Department Code:" + txtId.Text.Trim() + ", Department Name:" + txtName.Text.Trim() + " Added.")
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Department_Update")
            ...
            If result = 0 Then
                ...
                'Logger.system_log("Update Department Code:" + txtId.Text.Trim() + ", Department Name:" + txtName.Text.Trim())
    ...
    Private Sub LoadDeptData(ByVal intSlno As String, ByVal intMod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_Department_GetMaxMod")
    ...
    Private Function AuthorizeData() As TransState
        ...
        If result = 0 Then
            ...
            'Logger.system_log("Department Code:" + txtId.Text.Trim() + " Authorized.")
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Department_Remove")
        ...
        If result = 0 Then
            ...
            Dim tmpMod As Integer = _intModno

            _intModno = db.GetParameterValue(commProc, "@RET_MOD_NO")

            If tmpMod < _intModno Then
                Logger.system_log("Department Code:" + txtId.Text.Trim() + " Marked as deleted.")
            Else
                Logger.system_log("Department Code:" + txtId.Text.Trim() + " Removed unauthorized record.")
            End If
