...
Public Class FrmHolidaySumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceHolidaySummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Holiday_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = NullHelper.DateToString(dt.Rows(i).Item("HOLI_DAY"))
                dgView.Item(4, i).Value = dt.Rows(i).Item("HOLI_TYPE").ToString()
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmHoliDet As New FrmHolidayDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmHoliDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmHoliDet As New FrmHolidayDet
        frmHoliDet.Show()
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        db.AddInParameter(commProc, "@HOLI_DAY", DbType.DateTime, NullHelper.StringToDate(dgView.Rows(i).Cells(3).Value.ToString()))
                        ...
                        If result = 0 Then
                            ...
                            If _acmbholidayType <> _cmbholidayType Then
                                If _acmbholidayType = "" Then
                                    log_message = " Authorized : Holiday Day : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Holiday Type : " + _cmbholidayType
                                Else
                                    log_message = " Authorized : Holiday Day : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Holiday Type : " + _acmbholidayType + " " + " To " + " " + _cmbholidayType
                                End If
                            Else
                                log_message = " Authorized : Holiday Day : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Holiday Type : " + dgView.Rows(i).Cells(4).Value.ToString()
    ...
    Private Sub FrmHolidaySumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If cmbMonth.SelectedIndex = -1 Then
            MessageBox.Show("Select Month", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
            cmbMonth.Focus()
            Exit Sub
        End If

        If txtYear.Text.Trim() = "" Then
            MessageBox.Show("Search year required", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtYear.Focus()
            Exit Sub
        End If
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Holiday_GetDetailListByMonth")
            ...
            db.AddInParameter(commProc, "@P_MONTH", DbType.Int32, cmbMonth.SelectedIndex + 1)

            db.AddInParameter(commProc, "@P_YEAR", DbType.Int32, txtYear.Text.Trim())
