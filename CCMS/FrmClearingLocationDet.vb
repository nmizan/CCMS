...
Public Class FrmClearingLocationDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceClearingLocationDetail"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingLocation_Add")
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingLocation_Update")
    ...
    Private Sub LoadLocationData(ByVal strLocationCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingLocation_GetDetail")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_ClearingLocation_GetMaxMod")
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingLocation_Remove")
