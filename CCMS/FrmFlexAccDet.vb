...
'Purpose            : Flex Account maintenance
...
Public Class FrmFlexAccDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceFlexAccountDetail"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_FlexAcc_Update")
            ...
            If result = 0 Then
                ...
                If _AccNo <> txtAccNo.Text.Trim() Then
                    ...
                    log_message = " Updated : Serial No : " + txtId.Text.ToString() + "." + " " + " Account No : " + _AccNo + " " + " To " + " " + txtAccNo.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Serial No : " + txtId.Text.ToString() + "." + " " + " Account No : " + txtAccNo.Text.ToString()
                    Logger.system_log(log_message)
                End If
    ...
    Private Sub LoadAccDataForAuth(ByVal intSlno As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("SLNO").ToString()
    ...
    Private Sub LoadAccData(ByVal intSlno As Integer, ByVal intMod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_FlexAcc_GetMaxMod")
    ...
    Private Function AuthorizeData() As TransState
        ...
        If result = 0 Then
            ...
            If _aAccNo <> _AccNo Then
                If _aAccNo = "" Then
                    log_message = " Authorized : Serial No : " + txtId.Text.ToString() + "." + " " + " Account No : " + _AccNo
                Else
                    log_message = " Authorized : Serial No : " + txtId.Text.ToString() + "." + " " + " Account No : " + _aAccNo + " " + " To " + " " + _AccNo
                End If
                Logger.system_log(log_message)
            Else
                log_message = " Authorized : Serial No : " + txtId.Text.ToString() + "." + " " + " Account No : " + txtAccNo.Text.ToString()
                Logger.system_log(log_message)
            End If
            '------------Mizan Work (12-05-2016)------------
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_FlexAcc_Remove")
...
#End Region
    ...
    Private Sub FrmZoneDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadAccData(_intSlno, _intModno)
        End If
    ...
    Private Sub btnPrevVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrevVer.Click
        If _intModno - 1 > 0 Then
            LoadAccData(_intSlno, _intModno - 1)
        End If
    End Sub
