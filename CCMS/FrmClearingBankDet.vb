...
'Purpose            : Maintain Clearing Bank Detail
...
Public Class FrmClearingBankDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceClearingBankDetail"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingBank_Add")
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingBank_Update")
    ...
    Private Sub LoadBankData(ByVal strBankCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_ClearingBank_GetMaxMod")
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_ClearingBank_Remove")
...
#End Region
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strBank_Code.Trim() = "") Then
            ...
            If _status = "L" Or _status = "U" _
                    Or (_status = "D" And (chkAuthorized.Checked = False Or chkAuthorized.Checked = True)) Then
                EnableFields()
    ...
    Private Sub txtBBKCode_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtBBKCode.KeyDown
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{tab}")
        End If
    End Sub
    ...
    Private Sub txtAdd3_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtAdd3.KeyDown
        If e.KeyCode = Keys.Enter Then
