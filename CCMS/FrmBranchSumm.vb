...
Public Class FrmBranchSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceBranchSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Branch_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(13, i).Value = dt.Rows(i).Item("CORRBANK")
                dgView.Item(14, i).Value = dt.Rows(i).Item("NIKBRANCH_CODE").ToString()
                dgView.Item(15, i).Value = dt.Rows(i).Item("INPUT_BY").ToString()
                dgView.Item(16, i).Value = NullHelper.DateToString(dt.Rows(i).Item("INPUT_DATETIME"))
                dgView.Item(17, i).Value = dt.Rows(i).Item("INPUT_DATETIME")
                dgView.Item(18, i).Value = dt.Rows(i).Item("AUTH_BY").ToString()
                dgView.Item(19, i).Value = NullHelper.DateToString(dt.Rows(i).Item("AUTH_DATETIME"))
                dgView.Item(20, i).Value = dt.Rows(i).Item("ROUTING_NO")
            Next
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmBranchDet As New FrmBranchDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(4).Value, dgView.SelectedRows.Item(0).Cells(7).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmBranchDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmBranchDet As New FrmBranchDet
        frmBranchDet.Show()
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        '------------Mizan Work (18-05-2016)------------
                        LoadBranchData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(4).Value.ToString(), dgView.Rows(i).Cells(7).Value.ToString(), dgView.Rows(i).Cells(1).Value)

                        If (dgView.Rows(i).Cells(1).Value) > 1 Then
                            LoadBranchDataForAuth(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(4).Value.ToString(), dgView.Rows(i).Cells(7).Value.ToString())
                        End If
                        '------------Mizan Work (18-05-2016)------------
                        ...
                        db.AddInParameter(commProc, "@LOCATION_CODE", DbType.String, dgView.Rows(i).Cells(7).Value.ToString())
                        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, dgView.Rows(i).Cells(1).Value)
                        db.AddInParameter(commProc, "@MOD_DATETIME", DbType.DateTime, dgView.Rows(i).Cells(17).Value)
