...
Public Class FrmLocationDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceLocationDetail"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Location_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@LOCATION_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@LOCATION_NAME", DbType.String, txtName.Text.Trim())
            'db.AddInParameter(commProc, "@LOCATION_SHORT_NAME", DbType.String, txtSName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strLocation_Code = txtId.Text.Trim()

                _intModno = 1

                '------------Mizan Work (07-05-2016)------------

                log_message = " Added : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Location_Update")
            ...
            If result = 0 Then
                ...
                '------------Mizan Work (07-05-2016)------------
                If _LocName <> txtName.Text.Trim() Then
                    If _LocName = "" Then
                        log_message = " Updated : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + txtName.Text.ToString()
                    Else
                        log_message = " Updated : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + _LocName + " " + " To " + " " + txtName.Text.Trim()
                    End If
                Else
                    log_message = " Updated : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + txtName.Text.ToString()
                End If
    ...
    Private Sub LoadLocationDataForAuth(ByVal strLocationCode As String)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("LOCATION_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("LOCATION_NAME").ToString()
    ...
    Private Sub LoadLocationData(ByVal strLocationCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                'txtName.Text = ds.Tables(0).Rows(0)("LOCATION_SHORT_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("CMS_Location_GetMaxMod")
    ...
    Public Sub New(ByVal strLocationCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadLocationData(strLocationCode, intMod)
        _strLocation_Code = strLocationCode
        _intModno = intMod
    ...
    Private Function AuthorizeData() As TransState
        ...
        If result = 0 Then
            ...
            If _aLocName <> _LocName Then
                If _aLocName = "" Then
                    log_message = " Authorized : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + _LocName
                Else
                    log_message = " Authorized : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + _aLocName + " " + " To " + " " + _LocName
                End If
            Else
                log_message = " Authorized : Location Code : " + txtId.Text.Trim() + "." + " " + " Location Name : " + txtName.Text.ToString()
            End If
            Logger.system_log(log_message)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("CMS_Location_Remove")
...
#End Region
    ...
    Private Sub FrmLocationDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadLocationData(_strLocation_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strLocation_Code.Trim() = "") Then
    ...
    Private Sub btnPrevVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrevVer.Click
        If _intModno - 1 > 0 Then
            LoadLocationData(_strLocation_Code, _intModno - 1)
        End If
    End Sub
    ...
    Private Sub btnNextVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNextVer.Click
        ...
        If intModno > 0 Then
            ...
            If _intModno = 0 Then
                LoadLocationData(strLocationCode, intModno)
            End If
        End If
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        ...
        Try
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If _intModno > 1 Then
                    LoadLocationDataForAuth(_strLocation_Code)
                End If
