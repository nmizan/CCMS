...
Public Class ExportUtil
    ...
    Public Sub ExportXl()
        ...
        Try
            ...
            For row = 0 To totRow - 1
                ...
                For col = 0 To totCol - 1
                    If Not (_dgView.Columns(col).HeaderText.Trim() = "" Or _dgView.Columns(col).Visible = False) Then
                        rawData(row + 1, relCol) = NullHelper.StringToObject(_dgView.Rows(row).Cells(col).Value.ToString) 'dt.Rows(row).ItemArray(col)
                        relCol = relCol + 1
    ...
    Public Sub ExportXl(ByVal dt As DataTable)
