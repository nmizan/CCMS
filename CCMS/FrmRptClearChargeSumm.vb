...
Public Class FrmRptClearChargeSumm

    Dim _formName As String = "ReportClearingChargeCheckSummary"
    ...
    Private Sub ExportToXl()
        ...
        Try
            ...
            strSql = "SELECT OPR_DATE AS 'Date' ,COUNT(ACC_NO) as 'Volume', " & _
                                "SUM(AMOUNT) as 'Throughput' " & _
            ...
            If cmbValueType.SelectedIndex = 0 Then
                ...
                sheet.Cells(1, 1) = "Summary For " + Environment.NewLine + _
                "Regular Value Clearing" + Environment.NewLine + _
            ...
            ElseIf cmbValueType.SelectedIndex = 1 Then
                ...
                sheet.Cells(1, 1) = "Summary For " + Environment.NewLine + _
                "High Value Clearing" + Environment.NewLine + _
                NullHelper.DateToString(NullHelper.StringToDate(txtDepositDateFrom.Text), "dd-MMM-yy") + " To " + _
                NullHelper.DateToString(NullHelper.StringToDate(txtDepositDateTo.Text), "dd-MMM-yy")
