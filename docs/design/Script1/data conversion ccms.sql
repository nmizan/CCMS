...
INSERT INTO CCHECK(SLNO, D_CODE, CLIENT_CODE, DLOCATION_CODE, CUSTOMER_REF, SLIP_DATE, 
VALUE_DATE, CHECK_NO, AMOUNT, CHECK_DATE, CHECK_TYPE, DRAWER, DRAWEE_BANK_CODE, 
LOCATION_CODE, BRANCH_CODE, CHECK_REF, RTN_STATUS, NONZONE_REF, MOD_NO)
SELECT slno, d_code, client_code, dlocation_code, customer_ref, slip_date, 
value_date,check_no, amount, check_date, check_type, drawer, drawee_bankcode, 
location_code,branch_code, checkRef, [status], nonzoneref, 1 
...
INSERT INTO CSD_DET(D_CODE, SLNO, CHECK_NO, DRAWER, DRAWEE_BANK_CODE, AMOUNT, 
CUSTOMER_REF, SLIP_DATE, CHECK_DATE, DRAWEE_BRANCH, CHECK_REF, RTN_STATUS, MOD_NO )
SELECT d_code, slno,check_no, drawer, draweebank_code,   amount, 
customer_ref, slip_date, check_date, drawee_branch,  checkRef,rtnstatus,1)
FROM db_citibank.dbo.csd;
...
INSERT INTO (NONZONE_REF, REF_DATE, DDREFNO, AMOUNT, VAT, COMMISION, 
